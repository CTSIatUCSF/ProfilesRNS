...
namespace Profiles.Profile.Modules.NetworkClusterGroup
{
    public partial class NetworkClusterGroup : BaseModule
    {
        ...
        protected void InitAssets()
        {
            ...
            jsscript3.Attributes.Add("src", Brand.GetThemedDomain() + "/Profile/Modules/NetworkClusterGroup/JavaScript/networkBrowserClass.js");
            ...
            jsscript4.Attributes.Add("src", Brand.GetThemedDomain() + "/Profile/Modules/NetworkClusterGroup/JavaScript/networkClusterLayoutEngine.js");
            ...
            script.InnerHtml = "function loadClusterView() {" +
                " network_browser.Init('" + Brand.GetThemedDomain() + "/profile/modules/NetworkClusterGroup/NetworkClusterGroupSvc.aspx?p='); " +
