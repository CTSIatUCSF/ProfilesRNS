...
<asp:UpdatePanel ID="upnlEditCollaborationInterests" runat="server" class="EditPanel researcherprofiles--collaborationinterests-edit--container" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <section class="researcherprofiles--collaborationinterests-edit--section">
            <div class="researcherprofiles--collaborationinterests-edit--input-group">
                ...
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbAcademicCollaboration" runat="server" OnCheckedChanged="itmChanged"
                ...
                <!-- Academic Senate -->
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbAcademicSenateCommitteeService" runat="server" OnCheckedChanged="itmChanged"
                ...
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbMultiyearClinicalResearch" runat="server" OnCheckedChanged="itmChanged"
                ...
                <!-- Community -->
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbCommunityandPartnerOrganizations" runat="server" OnCheckedChanged="itmChanged"
                ...
                <!-- Companies -->
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbCompainesandEntrepreuners" runat="server" OnCheckedChanged="itmChanged"
                ...
                <!-- Policy -->
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbPolicyChange" runat="server" OnCheckedChanged="itmChanged"
                        Text="Policy Change" />
                    <div class="researcherprofiles--collaborationinterests-edit--desc">
                ...
                <!-- Press -->
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbPress" runat="server" OnCheckedChanged="itmChanged"
                        Text="Press" />
                    <div class="researcherprofiles--collaborationinterests-edit--desc">
                ...
                <!-- Donors -->
                <div class="researcherprofiles--collaborationinterests-edit--option-row">
                    <asp:CheckBox ID="cbProspectiveDonors" runat="server" OnCheckedChanged="itmChanged"
            ...
            <asp:TextBox ID="txtNarrative" runat="server" TextMode="MultiLine" Rows="4" OnTextChanged="itmChanged" CssClass="researcherprofiles--collaborationinterests-edit--textarea"></asp:TextBox>
