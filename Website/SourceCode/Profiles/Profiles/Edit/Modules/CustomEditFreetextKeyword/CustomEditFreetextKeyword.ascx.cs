...
namespace Profiles.Edit.Modules.CustomEditFreetextKeyword
{
    public partial class CustomEditFreetextKeyword : BaseModule
    {
            ...
            : base(pagedata, moduleparams, pagenamespaces)
        {
            ...
            txtLabel.Attributes.Add("data-autocomplete-url", Brand.GetDomain() + "/edit/Modules/CustomEditFreetextKeyword/keywordAutocomplete.aspx?keys=");
        }
        ...
        protected void GridViewProperty_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow && (e.Row.RowState & DataControlRowState.Edit) == DataControlRowState.Edit)
            {
                ...
                txtLabelGrid.Attributes.Add("data-autocomplete-url", Brand.GetDomain() + "/edit/Modules/CustomEditFreetextKeyword/keywordAutocomplete.aspx?keys=");
            }
        }
