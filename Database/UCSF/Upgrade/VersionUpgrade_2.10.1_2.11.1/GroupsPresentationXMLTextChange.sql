...
/****** Object:  StoredProcedure [RDF.].[GetPresentationXML]    Script Date: 11/8/2018 4:05:07 PM ******/
SET ANSI_NULLS ON
GO
	...
	BEGIN
		...
		BEGIN
			;WITH a AS (
				...
				SELECT 3 x, n.EditSecurityGroup SecurityGroupID, 'Owner' Label, 'Only managers of this group and special authorized users who manage this website.' Description
					FROM [RDF.].Node n
					WHERE n.NodeID = @Subject AND n.EditSecurityGroup > 0
