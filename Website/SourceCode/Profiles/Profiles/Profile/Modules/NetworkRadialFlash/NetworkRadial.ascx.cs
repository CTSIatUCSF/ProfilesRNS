...
namespace Profiles.Profile.Modules.NetworkRadialFlash
{
    public partial class NetworkRadial : BaseModule
    {
        ...
        protected void InitAssets()
        {
            ...
            jsscript1.Attributes.Add("src", Brand.GetDomain() + "/Profile/Modules/NetworkRadialFlash/scriptaculous/lib/prototype.js");
            ...
            jsscript2.Attributes.Add("src", Brand.GetDomain() + "/Profile/Modules/NetworkRadialFlash/scriptaculous/src/scriptaculous.js");
            ...
            jsscript3.Attributes.Add("src", Brand.GetDomain() + "/Profile/Modules/NetworkRadialFlash/JavaScript/networkBrowserClass.js");
            ...
            divSwfScript.InnerHtml = "<script language=\"JavaScript\" type=\"text/javascript\"> " +
               ...
               "'width', '600'," +
               "'height', '600'," +
               "'src', '" + Brand.GetDomain() + "/profile/Modules/NetworkRadialFlash/network_browser.swf'," +
               "'movie', '" + Brand.GetDomain() + "/profile/Modules/NetworkRadialFlash/network_browser'," +
               "'quality', 'high'," +
           ...
           "</script>";
            ...
            script.InnerHtml = "window.onload = function() {" +
                ...
                " network_browser.Init('" + Brand.GetDomain() + "/profile/modules/NetworkRadialFlash/NetworkRadialSvc.aspx?p='); " +
