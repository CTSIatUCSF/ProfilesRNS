...
namespace Profiles.Search.Modules.SearchOptions
{
    public partial class SearchOptions : BaseModule
    {
        ...
        private void BuildLinks()
        {
            ...
            litModifySearch.Text = "<a href=\"javascript:modify('" + Brand.GetDomain() + "','" + tab + "','" + base.MasterPage.SearchRequest + "');\">" + "Modify Search" + "</a>";
            ...
            litSearchOtherInstitutions.Text = "<a href='" + Brand.GetDomain() + "/direct/default.aspx?keyword=" + searchfor + "&searchrequest=" + base.MasterPage.SearchRequest + "&searchtype=" + Request.QueryString["searchtype"] + "'>" + "Search Other Institutions" + "</a>";
        }
