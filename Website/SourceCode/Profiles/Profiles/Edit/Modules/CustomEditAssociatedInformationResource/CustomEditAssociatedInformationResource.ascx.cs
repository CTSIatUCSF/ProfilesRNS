    ...
    public partial class CustomEditAssociatedInformationResource : BaseModule
    {
        ...
        protected void menuBtn_OnClick(object sender, EventArgs e)
        {
            ...
            if (buttonID.Equals("btnAddPub")) {
                ...
                //btnImgAddPub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareDownArrow.gif";
            }
            else {
            ...
            if (buttonID.Equals("btnAddCustom")) {
                ...
                Session["pnl.Visible"] = true;
                //btnImgAddCustom.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareDownArrow.gif";
            }
            else {
            ...
            if (buttonID.Equals("btnDeletePub")) {
                ...
                Session["pnl.Visible"] = true;
                //btnImgDeletePub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareDownArrow.gif";
            }
            else {
            ...
            if (buttonID.Equals("btnAddPubMed") || buttonID.Equals("btnPubMedById") || buttonID.Equals("btnPubMedReset")) {
                ...
                Session["pnl.Visible"] = true;
                //btnImgAddPubMed.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareDownArrow.gif";
            }
                ...
                //btnImgAddMemberPub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareDownArrow.gif";
            }
            else {
            ...
            if (buttonID.Equals("btnSyncMemberPubs") && !syncUserPubs) {
                ...
                Session["pnl.Visible"] = true;
                //btnImgSyncMemberPubs.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareDownArrow.gif";
            }
        ...
        private void reset()
        {
            ...
            //btnImgAddPub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
            //btnImgSyncMemberPubs.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
            //btnImgAddMemberPub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
            //btnImgAddPubMed.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
            //btnImgAddPub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
            //btnImgAddCustom.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
            //btnImgDeletePub.ImageUrl = Brand.GetThemedDomain() + "/Framework/images/icon_squareArrow.gif";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            litBackLink.Text = "<a href='" + Brand.GetThemedDomain() + "/edit/default.aspx?subject=" + _subject + "'>Edit Menu</a>" + " &gt; <b>" + PropertyListXML.SelectSingleNode("PropertyList/PropertyGroup/Property/@Label").Value + "</b>";
            if (data.GetGroupPublicationOption(_personId)) litSyncMemberPubs.Text = "(<b>On</b> / Off)";
            else litSyncMemberPubs.Text = "(On / <b>Off</b>)";
