    ...
    public partial class ComboTreeCheck : System.Web.UI.UserControl
    {
        ...
        public void ResetContent()
        {
            if (!IsPostBack)
            {
                ...
                ibExpand.ImageUrl = Brand.GetThemedDomain() + "/framework/Images/blank.gif";
        ...
        protected void rMaster_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                l_imgExpand.Attributes.Add("src", l_isExpand ? Brand.GetThemedDomain() + "/framework/images/expand.gif" : Brand.GetThemedDomain() + "/framework/images/collapse.gif");
