...
<div class='publicationList'>	
	<div style="font-weight:bold;color:#888;margin-bottom: 12px;margin-top:6px">
		...
		Researchers can <asp:Literal runat='server' ID='loginLiteral'></asp:Literal> to make corrections and additions, or <a href="mailto:profiles@lbl.gov">contact us for help</a>.
	</div>
