/****** Object:  StoredProcedure [Profile.Data].[Publication.Entity.UpdateEntity]    Script Date: 12/20/2018 10:42:15 AM ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	INSERT  INTO #Publications
			...
			WHERE	PG.PMID IN (
						...
						UNION
						SELECT PMID FROM [Profile.Data].[Publication.Group.Include]
						WHERE PMID IS NOT NULL)
...
/****** Object:  StoredProcedure [Profile.Data].[Publication.Entity.UpdateEntityOneGroup]    Script Date: 12/20/2018 10:33:56 AM ******/
SET ANSI_NULLS ON
GO
