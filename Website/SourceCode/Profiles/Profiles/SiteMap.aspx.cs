        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Request.Path.ToLower().EndsWith(".xml")) 
            {
                Response.Write("<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + Environment.NewLine +
                                    ...
                                    "<url><loc>" + Root.Domain + "/About/AboutUCSDProfiles.aspx</loc></url>" + Environment.NewLine +
            ...
            else 
            {
                Response.Write("<a href='" + Root.Domain + "'>" + Root.Domain + "</a>" + Environment.NewLine +
                               ...
                               "<a href='" + Root.Domain + "/About/AboutUCSDProfiles.aspx" + "'>" + Root.Domain + "/About/AboutUCSDProfiles.aspx" + "</a>" + Environment.NewLine +
