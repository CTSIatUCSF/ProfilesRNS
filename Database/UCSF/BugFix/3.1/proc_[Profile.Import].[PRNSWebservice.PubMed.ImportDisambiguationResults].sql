/****** Object:  StoredProcedure [Profile.Import].[PRNSWebservice.PubMed.ImportDisambiguationResults]    Script Date: 10/8/2021 8:15:38 AM ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [Profile.Import].[PRNSWebservice.PubMed.ImportDisambiguationResults] 
	@Job varchar(55) = '',
	@BatchID varchar(100) = '',
	@RowID int = -1,
	@LogID int = -1,
